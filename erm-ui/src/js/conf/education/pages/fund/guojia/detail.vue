      ...
      <Card :padding="10">
        ...
        <div class="fund-con">
          ...
          <div class="form-con">
            <Row :gutter="10">
              ...
              <Col span="6">
                ...
                <Select v-model="formList.schools" v-if="fundInfo.status > 3" disabled filterable multiple
                        placeholder="请选择">
                  <Option v-for="(item, $index) in schoolList" :key="$index" :value="item.id">{{item.name}}</Option>
                </Select>
              </Col>
          ...
          <div class="form-con">
            <Row :gutter="10">
              ...
              <Col span="6">
                <Input v-model="formList.desc" type="textarea" :autosize="{minRows: 5,maxRows: 10}"
        ...
        <v-table v-if="listData.length" :items="listData" :header="[]">
          <template slot="t-header">
            ...
            <th class="center"><p sort-key="schoolName"><span>学校名称</span><span class="sort"><i class="iconfont up">&#xe6f4;</i><i
              class="iconfont down">&#xe608;</i></span></p></th>
            <th class="center" v-if="fundInfo.subtype == '112'"><p sort-key="schzone"><span>学段</span><span class="sort"><i
              class="iconfont up">&#xe6f4;</i><i class="iconfont down">&#xe608;</i></span></p></th>
            <th class="center" v-if="fundInfo.subtype == '113'"><p sort-key="level"><span>资助级别</span><span class="sort"><i
              class="iconfont up">&#xe6f4;</i><i class="iconfont down">&#xe608;</i></span></p></th>
            <th class="center"><p sort-key="fundedName"><span>项目名称</span><span class="sort"><i class="iconfont up">&#xe6f4;</i><i
              class="iconfont down">&#xe608;</i></span></p></th>
            <th class="center"><p sort-key="statusName"><span>状态</span><span class="sort"><i class="iconfont up">&#xe6f4;</i><i
              class="iconfont down">&#xe608;</i></span></p></th>
            <th class="center"><p sort-key="count"><span>资助名额</span><span class="sort"><i
              class="iconfont up">&#xe6f4;</i><i class="iconfont down">&#xe608;</i></span></p></th>
    ...
    methods: {
      ...
      getSchoolList(id) {
        if (this.$route.query.type !== undefined) {
          io.get(api.school.listType, {
            subType: this.$route.query.type
          }, (res) => {
            let data = res.data
