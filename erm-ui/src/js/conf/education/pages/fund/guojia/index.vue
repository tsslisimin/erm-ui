<template>
  <div class="wrapper">
    ...
    <div class="con">
      <Card :padding="10">
        <Form ref="formList" :model="formList" :rules="ruleList" :label-width="80"
              style="padding-top: 15px;border-bottom: 1px dashed #d5d5d5;margin-bottom: 10px;">
        ...
        <v-table v-if="listData.length" :items="listData" :header="[]">
          <template slot="t-header">
            ...
            <th class="left"><p sort-key="name"><span>项目名称</span><span class="sort"><i
              class="iconfont up">&#xe6f4;</i><i class="iconfont down">&#xe608;</i></span></p></th>
            <th class="center"><p sort-key="semester"><span>年份</span><span class="sort"><i
              class="iconfont up">&#xe6f4;</i><i class="iconfont down">&#xe608;</i></span></p></th>
            <th class="center"><p sort-key="status"><span>状态</span><span class="sort"><i
              class="iconfont up">&#xe6f4;</i><i class="iconfont down">&#xe608;</i></span></p></th>
          ...
          <template slot="t-body" slot-scope="props">
            <tr>
              ...
              <td class="center">
                <Button type="primary" @click="edit(props.data.id)">分配</Button>
              </td>
            </tr>
          </template>
        </v-table>
  ...
  export default {
    ...
    methods: {
      ...
      edit(id) {
        ...
        let path = type != null ? '/fund/guojia/detail/' + id + '?type=112' : '/fund/guojia/detail/' + id
        this.$router.push({
          path: path
        })
      }
